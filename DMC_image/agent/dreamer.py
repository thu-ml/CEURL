...
class DreamerAgent(Module):
    ...
    def init_from(self, other):
        ...
        # we do not copy the reward model here
    ...
    def plan(self, obs, meta, step, eval_mode, state, t0=True):
        ...
        We thank the authors of TD-MPC (https://github.com/nicklashansen/tdmpc),
        to provide a good reference for implementing our planning strategy.
        """
...
class ActorCritic(Module):
    def __init__(self, config, act_spec, tfstep):
        ...
        self.critic_opt = common.Optimizer('critic', self.critic.parameters(), **self.cfg.critic_opt,
